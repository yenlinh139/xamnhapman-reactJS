    ...
    return (
        <div className="hydrometeorology-stats-demo">
            ...
            <div className="demo-section">
                ...
                <DateRangeSelector onDateRangeChange={handleDateRangeChange} className="demo-date-selector" />
            ...
            <div className="demo-section">
                ...
                <HydroDashboard period={dashboardPeriod} className="demo-dashboard" />
            </div>
            ...
            <div className="demo-section">
                ...
                <div className="alerts-grid">
                    <WeatherAlerts alertType="all" days={7} className="demo-alerts-week" />

                    <WeatherAlerts alertType="critical" days={30} className="demo-alerts-critical" />
                </div>
            </div>
            ...
            <div className="demo-section">
                ...
                <div className="api-test-grid">
                    <button onClick={() => testAPI("/hydrometeorology-stations")} className="api-test-button">
                        Test Stations API
                    </button>

                    <button onClick={() => testAPI("/hydrometeorology-latest")} className="api-test-button">
