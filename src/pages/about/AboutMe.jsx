  ...
  const researchObjectives = [
    {
      ...
      description:
        'Thiết lập cơ sở dữ liệu không gian toàn diện để giám sát và cảnh báo xâm nhập mặn.',
    },
    {
      icon: '🌊',
      title: 'Phát triển WebGIS',
      description:
        'Xây dựng hệ thống WebGIS hiện đại hỗ trợ theo dõi độ mặn theo thời gian thực.',
    },
    {
      icon: '⚡',
      title: 'Cảnh báo tự động',
      description:
        'Thiết lập cơ chế thông báo tự động khi độ mặn vượt ngưỡng an toàn cho phép.',
    },
    {
      icon: '📊',
      title: 'Trực quan hóa dữ liệu',
      description:
        'Hiển thị dữ liệu thủy văn một cách trực quan, hỗ trợ ra quyết định hiệu quả.',
    },
  ];
            ...
            <div className="content-wrapper">
              <div className="text-content">
                <p className="highlight-text">
                  Xâm nhập mặn là một trong những thách thức nghiêm trọng đối
                  với hệ thống sông, kênh, rạch tại Thành phố Hồ Chí Minh, ảnh
                  hưởng đến nguồn nước ngọt và đời sống người dân.
                </p>
                <p>
                  Trước thực trạng này, khóa luận{' '}
                  <strong>
                    "Phát triển WebGIS giám sát và cảnh báo xâm nhập mặn trên hệ
                    thống sông, kênh, rạch tại Thành phố Hồ Chí Minh"
                  </strong>{' '}
                  được thực hiện nhằm xây dựng một hệ thống giám sát thông minh,
                  hỗ trợ quản lý tài nguyên nước và đưa ra cảnh báo kịp thời.
                </p>
              </div>
